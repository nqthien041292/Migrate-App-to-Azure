...
class BaseConfig:
    ...
    SERVICE_BUS_CONNECTION_STRING ='Endpoint=sb://developerproject3servicebusspace.servicebus.windows.net/;SharedAccessKeyName=RootManageSharedAccessKey;SharedAccessKey=hosJULprgyIo6/INUbIRmPl6ydBYMCZCP+ASbFBw74w=' #TODO: Update value
