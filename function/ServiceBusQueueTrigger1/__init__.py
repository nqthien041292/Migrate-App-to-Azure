...
def main(msg: func.ServiceBusMessage):
    ...
    connection = psycopg2.connect(dbname="techconfdb", user="nqthien041292@developerproject3server", password="123qwexX", host="developerproject3server.postgres.database.azure.com")
